package pl.edu.pja.gdansk.voyage2.folder.controller.myroute;
...
@WebAppConfiguration
@ActiveProfiles("test")
public class FindMyRouteControllerTest extends BaseControllerTest {
    ...
    public void find() throws Exception {
        ...
        this.mockMvc
                ...
                .andDo(document("folder-myroute-find"))
        ;
    }
}